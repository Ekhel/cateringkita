		...
		$.ajax({
			...
			success: function (result) {
				...
				if (tabel == "primary") {
					...
					$("#harga_modal_primary_lihat").val(
						convertToRupiah(result[0].harga_modal)
					);
					$("#harga_jual_primary_lihat").val(
						convertToRupiah(result[0].harga_jual)
					);
					$("#harga_sewa_jam_primary_lihat").val(
						convertToRupiah(result[0].harga_sewa_jam)
					);
					$("#harga_primary_lihat").val(
						convertToRupiah(result[0].harga_sewa_bulan)
					);
					...
					$("#harga_modal_secondary_lihat").val(
						convertToRupiah(result[0].harga_modal)
					);
	...
	$("#modal-edit-biayalain").on("show.bs.modal", function (event) {
		...
		$.ajax({
			...
			success: function (result) {
				...
				$("#typebiaya1")
					.select2()
					.val(result.biayalain[0].kd_biaya)
					.trigger("change");
