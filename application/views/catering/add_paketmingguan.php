                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card-header">
                                <div class="p-4">
                                    <div class="osahan-user text-center">
                                        <h4 class="text-dark mt-0 mb-0" style="font-weight: bold;">Tambah Pesanan Mingguan</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body" id="bagian_data_pesanan" style="display: none;">
                                <form action="<?= base_url('catering/add_pemesanan_mingguan') ?>" method="POST" autocomplete="off">
                                    <div class="shop-head mb-3">
                                        <h5 class="mb-1 text-dark text-center" style="font-weight: bold;">Data Detail Pemesanan</h5>
                                    </div>
                                    <input type="hidden" class="form-control" name="order_type" id="order_type" value="mingguan" required />
                                    <input type="hidden" class="form-control" name="total_hari" id="total_hari" value="7" required />
                                    ...
                                    <div class="card-body osahan-payment">
                                        ...
                                        <p class="mb-1">Total Hari <span class="float-right text-dark" id="txt_total_hari">7</span></p>
