    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <img class="rounded img-fluid" src="<?= base_url() ?>assets/images/logo_website/<?= $logo['nm_logo'] ?>" width="200px" alt="Card image cap">
                <h2 class="mt-4 mb-1 text-white">Apa Itu <b>"CateringKita"</b>?</h2>
                ...
                <div class="row mt-5">
                    <div class="col-lg-6">
                        <div class="text-left bg-white p-4 shadow-sm rounded">
                            <h5 class="text-dark mt-0">Visi</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="text-left bg-white p-4 shadow-sm rounded">
                            <h5 class="text-dark mt-0">Misi</h5>
