                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <br>
                            <table class="table table-hover text-nowrap table-striped table-bordered" id="mytablePesananTertunda" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Nomor</th>
...
<!--MODAL DELETE-->
<form id="hapusOrder">
    <div class="modal fade" id="hapusmodalPesananTertunda" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="special-box">
                                                ...
                                                <div class="table-responsive-sm">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <table class="table">
                                                                <tbody id="detail_order_kurir_1_pesanan_tertunda">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <table class="table">
                                                                <tbody id="detail_order_kurir_2_pesanan_tertunda">
                                        ...
                                        <div class="card-body">
                                            <div class="col-lg-12">
                                                <div class="special-box">
                                                    ...
                                                    <div class="table-responsive-sm">
                                                        <table class="table">
                                                            <tbody id="detail_order_kurir_3_pesanan_tertunda">
                                        ...
                                        <div class="card-body">
                                            <div class="col-lg-12">
                                                <div class="special-box">
                                                    ...
                                                    <div class="table-responsive-sm">
                                                        <table class="table">
                                                            <tbody id="detail_order_kurir_4_pesanan_tertunda">
                                                    ...
                                                    <div class="special-box">
                                                        ...
                                                        <div class="table-responsive-sm">
                                                            <table class="table table-bordered table-hover">
                                                                ...
                                                                <tbody id="detail_order_kurir_5_pesanan_tertunda" class="text-center">
