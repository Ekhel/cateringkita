...
if (in_array('1', $dataTampunganRole) || $this->session->userdata('kd_role') == "reseller") {
} else {
...
<div class="content-wrapper">
    ...
    <section class="content">
        <form id="editOrder" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="row">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="stat_ongkir" value="0">
                            ...
                            <div class="card-body">
                                <div class="form-group" id="detailProduk">
                                    <div class="row">
                                        <div class="col-md-4" id="produkk1">
                                            ...
                                            <select class="form-control select2produk1" name="eproduk[]" id="produk1" style="width: 100%;" required>
                                                <option value="<?= substr($detail_order[0]['kd_produk'], 0, 2) == "PR"  ? $detail_order[0]['kd_produk'] : $detail_order[0]['kd_detail_produk'] ?>"><?= substr($detail_order[0]['kd_produk'], 0, 2) == "PR" ? $promoo['nama_promo'] : $detail_order[0]['nm_produk'] . " - " . $detail_order[0]['berat_produk'] . " " . $detail_order[0]['satuan_berat_produk'] ?></option>
                                            </select>
                                        </div>
                                        <div class="col-md-4" id="nominall">
                                            <label for="jmlkomisi1">Jumlah Ujroh (U/Reseller)</label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" class="form-control rupiah-mask" name="diskonn[]" id="diskonn1" value="<?= $detail_order[0]['diskon'] / $detail_order[0]['qty'] ?>" placeholder="Masukan Diskon" readonly>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-4">
                                    ...
                                    <?php for ($i = 1; $i < count($detail_order); $i++) { ?>
                                        <?php if (substr($detail_order[$i]['kd_produk'], 0, 2) == "PR") {
                                            $promoo = $this->db->get_where('promo', ['kd_promo' => $detail_order[$i]['kd_produk']])->row_array();
                                        }  ?>
                                        <?php $j = json_decode($i); ?>
                                        <div id="bagianProdukhapus<?= ++$j ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4" id="produkk1">
                                                    <input type="hidden" name="kd_detail[]" id="kd_detail<?= $j ?>" value="<?= $detail_order[$i]['kd_detail_order'] ?>">
                                                    <label for="produk1">Nama Menu</label>
                                                    <select class="form-control select2produk<?= $j ?>" name="eproduk[]" id="produk<?= $j ?>" style="width: 100%;" required>
                                                        <option value="<?= substr($detail_order[$i]['kd_produk'], 0, 2) == "PR"  ? $detail_order[$i]['kd_produk'] : $detail_order[$i]['kd_detail_produk'] ?>"><?= substr($detail_order[$i]['kd_produk'], 0, 2) == "PR" ? $promoo['nama_promo'] : $detail_order[$i]['nm_produk'] . " - " . $detail_order[$i]['berat_produk'] . " " . $detail_order[$i]['satuan_berat_produk'] ?></option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4" id="nominall">
                                                    <label for="jmlkomisi1">Jumlah Ujroh (U/Reseller)</label>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" class="form-control rupiah-mask" name="ediskonn[]" id="diskonn<?= $j ?>" value="<?= $detail_order[$i]['diskon'] / $detail_order[$i]['qty'] ?>" placeholder="Masukan Diskon" readonly>
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="icheck-primary <?= $order_member['alamat_lain'] == '0' ? "d-none" : "d-inline" ?>" id="checkboxmemberr">
                                        <input type="checkbox" name="checkboxmembernull" id="checkboxmembernull" <?= $order_member['alamat_member_null'] == '1' ? "checked" : "" ?>>
                                        <label for="checkboxmembernull" style="margin-left: 20px;">
                                            Member Tidak Ada ?
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" name="kecamatan_utama_hid" id="kecamatan_utama_hid" value="<?= $order_member['kd_member'] != "#" ? $order_member['kd_subdistricts'] : '' ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div ccattaalass="form-group">
                                                ...
                                                <div class="nm_penerimaa" style="<?= $order_member['alamat_member_null'] == "1" ? 'display:none;' : '' ?>">
                                                    <select class="form-control select2memberlain" name="nm_penerima_lain" id="nm_penerima_lain" style="width: 100%;" required>
                                                        <option value="<?= $order_member['cust_name'] ?>"><?= $order_member['cust_name'] . " - " . $order_member['cust_phone']  ?></option>
                                                    </select>
                                                </div>
                                                <input type="text" name="nm_penerima_lain_null" value="<?= $order_member['cust_name']  ?>" class="form-control" id="nm_penerima_lain_null" placeholder="" style="<?= $order_member['alamat_member_null'] == '0' ? "display:none"  : "" ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                ...
                                <div class="row" id="ongkirKelurahan">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="pilihan_kurir" id="pilihan_kurir" class="form-control">
                                                <option value="" <?= $order_member['pilihan_kurir'] == "" ? "selected" : "" ?>>Pilih Jenis Kurir</option>
                                                <option value="CateringKita" <?= $order_member['pilihan_kurir'] == "CateringKita" ? "selected" : "" ?>>Selera Reguler</option>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control jarak_member" name="jarak" id="jarak" placeholder="0 KM" required readonly>
                                            <input type="text" class="form-control alamat_member" value="<?= $order_member['alamat_untuk_ongkir'] ?>" id="searchmap" placeholder="masukkan kelurahan" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ongkir_utama" value="<?= $order_member['ongkir'] ?>" class="form-control input-rupiah-mask" id="ongkir_utama" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div>
                                            <label for="diskon_tambahan">Diskon Tambahan</label>
                                            <input type="text" name="diskon_tambahan" id="diskon_tambahan" class="form-control input-rupiah-mask" value="<?= $order_member['diskon_tambahan'] ?>" placeholder="Masukan Diskon Tambahan" <?= $this->session->userdata('kd_admin') ? '' : 'readonly'  ?>>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" id="checkOrder" class="btn btn-primary">Submit</button>
