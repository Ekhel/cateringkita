...
<div class="content-wrapper">
    ...
    <section class="content">
        <form id="addOrder" novalidate autocomplete="off">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="subregion" class="form-control" id="subregion">
                                <input type="hidden" name="city" class="form-control" id="city">
                                <input type="hidden" name="nbrhd" class="form-control" id="nbrhd">
                                ...
                                <div class="form-group" id="detailProduk">
                                    <div class="row">
                                        <div class="col-md-4" id="produkk1">
                                            ...
                                            <select class="form-control select2produk1" name="produk[]" id="produk1" style="width: 100%;" required>
                                        ...
                                        <div class="col-md-4" id="nominall">
                                            ...
                                            <input type="text" name="jmlkomisi[]" id="jmlkomisi1" class="form-control rupiah-mask" placeholder="Masukan Nominal" readonly>
                                            <input type="hidden" name="jmlkomisii[]" id="jmlkomisii1" class="form-control" placeholder="Masukan Nominal" readonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="diskon">Diskon</label>
                                            <input type="text" class="form-control rupiah-mask" name="diskon[]" id="diskon1" placeholder="Masukan Diskon" readonly>
                                            <input type="hidden" class="form-control rupiah-mask" name="diskonn[]" id="diskonn1" placeholder="Masukan Diskon" readonly>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-4">
                                            <label for="harga_produk">Harga Menu</label>
                                            <input type="text" class="form-control rupiah-mask" name="harga_produk[]" id="harga_produk1" placeholder="Masukan Produk" readonly required>
                                        </div>
                                        <div class="col-md-2" id="stokk">
                                            <label for="qty1">Qty</label>
                                            <input type="text" name="qty[]" id="qty1" class="form-control" placeholder="Masukan Stok" readonly required>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="sub_total1">Sub Total</label>
                                            <input type="text" name="sub_total[]" id="sub_total1" class="form-control rupiah-mask" placeholder="Masukan Satuan Kilogram" readonly required>
                                        </div>
                                        <div class="col-md-2">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group" id="checkboxalamat1">
                                    ...
                                    <div class="icheck-primary d-none" id="checkboxmemberr">
                                        <input type="checkbox" name="checkboxmembernull" id="checkboxmembernull">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div ccattaalass="form-group">
                                                ...
                                                <div class="nm_penerimaa">
                                                    <select class="form-control select2memberlain" name="nm_penerima_lain" id="nm_penerima_lain" style="width: 100%;" required>
                                                        <option value="#">Pilih Pelanggan</option>
                                                    </select>
                                                </div>
                                                <input type="text" name="nm_penerima_lain_null" class="form-control" id="nm_penerima_lain_null" placeholder="" style="display: none;">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                ...
                                <div class="row" id="ongkirKelurahan">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="pilihan_kurir" id="pilihan_kurir" class="form-control">
                                                ...
                                                <option value="CateringKita">Selera Reguler</option>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control alamat_member" name="searchmap" id="searchmap" placeholder="masukkan kelurahan" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="modal-member-reseller">
