<?php
if ($this->session->userdata('kd_role') == "1" || $this->session->userdata('kd_role') == "8" || $this->session->userdata('kd_role') == "9") {
} else {
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <br>
                            <table class="table table-hover text-nowrap table-striped table-bordered" id="mytablePesananDitolak">
                                <thead>
                                    <tr>
                                        <th>Nomor</th>
                                        <th>Kode Order</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama Kategori</label>
                        <input type="text" name="nm_kategori" id="nm_kategori_edit" class="form-control" placeholder="Nama Kategori">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
