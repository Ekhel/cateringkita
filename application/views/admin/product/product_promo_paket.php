                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <br>
                            <table class="table table-hover text-nowrap table-striped table-bordered" id="mytablePromoPaket" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Nomor</th>
                                        <th>Nama Promo</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row" id="bagian_tanggal">
                        <div class="col-md-6 col-xs-12 col-12" id="bagian_tanggal_start">
