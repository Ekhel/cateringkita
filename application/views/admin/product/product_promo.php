                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <div class="col-md-12">
                                <h1>
                                    <a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add" data-backdrop="static" data-keyboard="false"><span class="fa fa-plus"></span> Add Promo</a>
                                </h1>
                            </div>
                            <br>
                            <table class="table table-hover text-nowrap table-striped table-bordered" id="mytablePromo" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Nomor</th>
                                        <th>Nama Promo</th>
...
<form id="addPromoProduct" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-xs-8 col-8">
                            <div class="form-group">
                                <label>Produk</label>
                                <select name="produk[]" class="form-control select2produk" id="promo_produk" required>
                        ...
                        <div class="col-md-4 col-xs-4 col-4">
                            ...
                            <input type="text" class="form-control input-rupiah-mask" name="harga_produk[]" id="harga_produk" placeholder="Harga Menu" readonly required>
                        </div>
                        <div class="col-md-11 col-xs-10 col-10">
                            <label>Harga Promo</label>
                            <input type="text" class="form-control input-rupiah-mask" name="harga_promo[]" id="harga_promo" placeholder="Harga Promo" required>
                        </div>
                        <div class="col-md-1 col-xs-1 col-1">
                            <label for="kd_supplier"></label><br>
                            <a href="javascript:void(0);" class="btn btn-success mt-2 " id="buttontambahproduk"> <i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                    <div id="bagiantambahproduk"></div>
...
<form id="editPromoProduct" autocomplete="off">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="edit_bagiantambahproduk"></div>
                    <div id="edit_bagiantambahproduk1"></div>
                    <a href="javascript:void(0);" class="btn btn-success mt-2 btn-block" id="editbuttontambahproduk">Tambah Menu <i class="fa fa-plus"></i></a>
