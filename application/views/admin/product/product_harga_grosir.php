                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <div class="col-md-12">
                                <h1>
                                    <a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add" data-backdrop="static" data-keyboard="false"><span class="fa fa-plus"></span> Add Menu</a>
                                </h1>
                            </div>
                            <br>
                            <table class="table table-hover text-nowrap table-striped table-bordered" id="mytableHargaGrosir" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Nomor</th>
                                        <th>Nama Promo</th>
...
<form id="addHargaGrosir" autocomplete="off">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row" id="bagian_waktu">
                        <div class="col-md-4 col-xs-4 col-4" id="bagian_waktu_start">
                            <label>Waktu Mulai</label>
                            <input type="time" class="form-control" name="time_start" id="time_start">
                        </div>
                        <div class="col-md-4 col-xs-4 col-4" id="bagian_waktu_end">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xs-4 col-4">
                            <div class="form-group">
                                <label>Produk</label>
                                <select name="produk[]" class="form-control select2produkgrosir" id="promo_produk" required>
                        ...
                        <div class="col-md-1 col-xs-1 col-1">
                            <label>QTY</label>
                            <input type="text" class="form-control" name="qty[]" id="qtygrosir1" placeholder="QTY" required>
                        </div>
                        <div class="col-md-3 col-xs-3 col-3">
                            <label for="harga_produk">Harga Grosir</label>
                            <div class="input-group">
                                <input type="text" class="form-control input-rupiah-mask" name="harga_grosir[]" id="harga_grosir1" placeholder="Harga Grosir" required>
                        ...
                        <div class="col-md-1 col-xs-1 col-1">
                            ...
                            <a href="javascript:void(0);" class="btn btn-success mt-2 " id="buttontambahprodukGrosir"> <i class="fa fa-plus"></i></a>
                        </div>
                    </div>
...
<form id="editHargaGrosir" autocomplete="off">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama Promo</label>
                        <input type="hidden" class="form-control" name="kode_grosir" id="edit_kode_grosir" placeholder="Masukkan Nama Promo" required>
                        <input type="text" class="form-control" name="nama_grosir" id="edit_nama_grosir" placeholder="Masukkan Nama Promo" required>
                    </div>
                    <div class="form-group" style="display: none;">
                        <label>Jenis Promo</label>
                        <select name="jenis_promo" id="jenis_promo" class="form-control">
                    ...
                    <div id="edit_bagiantambahprodukgrosir1"></div>

                    <a href="javascript:void(0);" class="btn btn-success mt-2 btn-block" id="editbuttontambahprodukgrosir">Tambah Menu <i class="fa fa-plus"></i></a>
    ...
    <div class="edit-tmpt-ujroh-grosir"></div>
</form>
