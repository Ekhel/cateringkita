        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <a href="<?= base_url('excel/template-sub_kategori.xlsx') ?>" class="btn btn-success">Download Format</a>
                            </div>
                            <br>
                            <?= form_open_multipart('kategori/preview_sub_kategori'); ?>
                ...
                <?php if (isset($_POST['preview'])) : ?>
                    <div class="col-12" id="excel_subkategori">
                        <input type="hidden" name="jml_record" id="jml_record" value="<?= isset($_POST['preview']) ? count($import) : '' ?>">
                        <div class="card">
                            <div class="card-body">
                                <?= form_open('kategori/upload_excel_act_sub_kategori', null, ['data' => json_encode($import)]); ?>
                                ...
                                <table class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <?php
                                                if ($data['nm_sub_kategori'] == null) {
                                                    echo '<tr><td colspan="10" class="text-center">Data kosong! pastikan anda menggunakan format yang telah disediakan.</td></tr>';
                                                } else { ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        <td width="40%">
                                                            <select name="kd_kategori[]" class="form-control select2kategori<?= $no ?>"></select>
                                                        </td>
                                                        <td class="<?= $data['nm_sub_kategori'] == null ? 'bg-warning' : ''; ?>">
                                                            <?= $data['nm_sub_kategori'] == null ? '<font color=red>BELUM DIISI</font>' : $data['nm_sub_kategori']; ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
